...
public partial class WarehouseSettingFormWindow : Window
{
    public WarehouseSettingFormViewModel ViewModel { get; }

    public WarehouseSettingFormWindow(WarehouseSettingFormViewModel viewModel)
    {
        InitializeComponent();
        ViewModel   = viewModel;
    ...
    public void Initialize(WarehouseSetting? warehouse = null) => ViewModel.Initialize(warehouse);
