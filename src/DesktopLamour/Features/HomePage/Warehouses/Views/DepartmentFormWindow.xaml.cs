...
{
    public DepartmentFormViewModel ViewModel { get; }

    public DepartmentFormWindow(DepartmentFormViewModel viewModel)
    {
        InitializeComponent();
        ViewModel   = viewModel;
    ...
    public void Initialize(Department? department = null) => ViewModel.Initialize(department);
