...
public sealed class ExpenseCategoryCacheStore : EntityCacheStore<ExpenseCategoryResponseDto>, IExpenseCategoryCacheStore
{
    public ExpenseCategoryCacheStore() : base(e => e.Id)
    {
    }
}
