...
public sealed class CreateExpenseCategoryUseCase : ICreateExpenseCategoryUseCase
{
    private readonly IExpenseCategoryRepository _repository;
    public CreateExpenseCategoryUseCase(IExpenseCategoryRepository repository) => _repository = repository;

    public async Task<ExpenseCategory> ExecuteAsync(CreateExpenseCategoryInput input, CancellationToken ct = default)
    {
        ...
        if (existing.Any(e => e.Code.Equals(input.Code.Trim(), StringComparison.OrdinalIgnoreCase)))
