...
public partial class ProductUnitFormWindow : Window
{
    public ProductUnitFormViewModel ViewModel { get; }

    public ProductUnitFormWindow(ProductUnitFormViewModel viewModel)
    {
        InitializeComponent();
        ViewModel   = viewModel;
    ...
    public void Initialize(ProductUnit? unit = null) => ViewModel.Initialize(unit);
