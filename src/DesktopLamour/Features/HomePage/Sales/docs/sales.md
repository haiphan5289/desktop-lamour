...
- **Acceptance criteria:**
  ...
  - [x] `SalesView` (màn hình hub "Bán hàng", vào từ Trang chủ → 🛒 Bán hàng, còn 4 tile: Chứng từ bán hàng/Hàng bán bị trả lại/Phiếu cọc/Báo cáo trừ cọc — tile "📊 Báo cáo" đã bị xoá) — panel "📊 Báo cáo bán hàng theo Mặt hàng" nhúng ngay dưới lưới tile, là cách DUY NHẤT xem báo cáo bán hàng trong toàn bộ module Sales. Có đầy đủ field lọc (Kỳ báo cáo preset/Từ-Đến ngày/Đơn vị tính/Nhóm VTHH/Nhân viên/Khách hàng/Mặt hàng checklist multi-select) + nút "🔍 Lọc"/"Xóa điều kiện", chuyển nguyên từ popup `SalesOrderReportFilterWindow` cũ (2026-08-22). Tự load lookup + báo cáo mặc định (Kỳ báo cáo = Đầu tháng đến hiện tại) khi vào màn hình; luôn cộng dồn theo Mặt hàng (dimension cố định, không đổi được); có nút "▲ Thu gọn"/"▼ Mở rộng" để ẩn/hiện
