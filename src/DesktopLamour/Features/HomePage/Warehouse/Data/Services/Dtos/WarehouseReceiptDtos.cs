...
public class WarehouseReceiptResponseDto
{
    ...
    // 2026-09-11: chỉ có ý nghĩa cho PN tự động lập từ SalesReturn (ReceiptType.ReturnedGoods) —
    // true khi chứng từ trả hàng gốc đã bị sửa sau khi lập PN này, PN mới đã được lập thay thế.
