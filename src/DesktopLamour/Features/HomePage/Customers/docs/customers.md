...
- [`ViewModels/CustomerListViewModel.cs`](../ViewModels/CustomerListViewModel.cs) — Commands: `LoadCustomers`, `AddCustomer`, `EditCustomer`, `DeleteCustomer`, `DuplicateCustomer`, `GoBack`
