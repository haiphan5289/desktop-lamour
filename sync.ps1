...
$r1 = robocopy Z:\src C:\projects\desktop-lamour\src /E /FFT /MT:8 /NP /NDL /NJH /XF *.user /XD obj bin .git
...
$r2 = robocopy Z:\ C:\projects\desktop-lamour\ /LEV:1 /FFT /MT:8 /NP /NDL /NJH /XF *.user
